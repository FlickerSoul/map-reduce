...
// ThreadPool<T, W>::ThreadPool(int thread_num, std::queue<T> work_queue, W worker) {
...
// template <typename T, typename W>
// void ThreadPool<T, W>::remove_worked_thread(T work_input) {
...
// template <typename T, typename W>
// void ThreadPool<T, W>::job_helper(T job_input) {
